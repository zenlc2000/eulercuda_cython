...
#define __PYX_HAVE__pydebruijn
#define __PYX_HAVE_API__pydebruijn
#include "common.h"
#include "graph.h"
#include "debruijn.h"
#include "string.h"
...
static CYTHON_INLINE PyObject* __Pyx_PyInt_From_KEY_T(KEY_T value);

static PyObject* __pyx_convert__to_py_EulerVertex(EulerVertex s);
static CYTHON_INLINE KEY_T __Pyx_PyInt_As_KEY_T(PyObject *);

static PyObject *__pyx_memview_get_nn_EulerVertex(const char *itemp);
static int __pyx_memview_set_nn_EulerVertex(const char *itemp, PyObject *obj);

static PyObject* __pyx_convert__to_py_EulerEdge(EulerEdge s);
static PyObject *__pyx_memview_get_nn_EulerEdge(const char *itemp);
static int __pyx_memview_set_nn_EulerEdge(const char *itemp, PyObject *obj);
...
static CYTHON_INLINE __Pyx_memviewslice __Pyx_PyObject_to_MemoryviewSlice_dsds_nn_EulerVertex(PyObject *);

static CYTHON_INLINE __Pyx_memviewslice __Pyx_PyObject_to_MemoryviewSlice_dsds_int(PyObject *);

static CYTHON_INLINE __Pyx_memviewslice __Pyx_PyObject_to_MemoryviewSlice_dsds_nn_EulerEdge(PyObject *);
...
/* Module declarations from 'pydebruijn' */
...
static EulerVertex __pyx_convert__from_py_EulerVertex(PyObject *); /*proto*/
static EulerEdge __pyx_convert__from_py_EulerEdge(PyObject *); /*proto*/
static __Pyx_TypeInfo __Pyx_TypeInfo_int = { "int", NULL, sizeof(int), { 0 }, 0, IS_UNSIGNED(int) ? 'U' : 'I', IS_UNSIGNED(int), 0 };
static __Pyx_TypeInfo __Pyx_TypeInfo_nn_KEY_T = { "KEY_T", NULL, sizeof(KEY_T), { 0 }, 0, IS_UNSIGNED(KEY_T) ? 'U' : 'I', IS_UNSIGNED(KEY_T), 0 };
static __Pyx_StructField __Pyx_StructFields_nn_EulerVertex[] = {
  {&__Pyx_TypeInfo_nn_KEY_T, "vid", offsetof(EulerVertex, vid)},
  {&__Pyx_TypeInfo_int, "ep", offsetof(EulerVertex, ep)},
  {&__Pyx_TypeInfo_int, "ecount", offsetof(EulerVertex, ecount)},
  {&__Pyx_TypeInfo_int, "lp", offsetof(EulerVertex, lp)},
  {&__Pyx_TypeInfo_int, "lcount", offsetof(EulerVertex, lcount)},
  {NULL, NULL, 0}
};
static __Pyx_TypeInfo __Pyx_TypeInfo_nn_EulerVertex = { "EulerVertex", __Pyx_StructFields_nn_EulerVertex, sizeof(EulerVertex), { 0 }, 0, 'S', 0, 0 };
static __Pyx_StructField __Pyx_StructFields_nn_EulerEdge[] = {
  {&__Pyx_TypeInfo_nn_KEY_T, "eid", offsetof(EulerEdge, eid)},
  {&__Pyx_TypeInfo_int, "v1", offsetof(EulerEdge, v1)},
  {&__Pyx_TypeInfo_int, "v2", offsetof(EulerEdge, v2)},
  {&__Pyx_TypeInfo_int, "s", offsetof(EulerEdge, s)},
  {&__Pyx_TypeInfo_int, "pad", offsetof(EulerEdge, pad)},
  {NULL, NULL, 0}
};
static __Pyx_TypeInfo __Pyx_TypeInfo_nn_EulerEdge = { "EulerEdge", __Pyx_StructFields_nn_EulerEdge, sizeof(EulerEdge), { 0 }, 0, 'S', 0, 0 };
#define __Pyx_MODULE_NAME "pydebruijn"
int __pyx_module_is_main_pydebruijn = 0;

/* Implementation of 'pydebruijn' */
...
static char __pyx_k_d_TK[] = "d_TK";
static char __pyx_k_d_TV[] = "d_TV";
...
static char __pyx_k_ecount[] = "ecount";
...
static char __pyx_k_kmerCount[] = "kmerCount";
static char __pyx_k_lmerCount[] = "lmerCount";
static char __pyx_k_IndexError[] = "IndexError";
static char __pyx_k_ValueError[] = "ValueError";
static char __pyx_k_d_kmerKeys[] = "d_kmerKeys";
static char __pyx_k_d_lmerKeys[] = "d_lmerKeys";
static char __pyx_k_pydebruijn[] = "pydebruijn";
static char __pyx_k_pyx_vtable[] = "__pyx_vtable__";
static char __pyx_k_MemoryError[] = "MemoryError";
static char __pyx_k_d_bucketSeed[] = "d_bucketSeed";
static char __pyx_k_d_lmerValues[] = "d_lmerValues";
...
static char __pyx_k_constructDebruijnGraphDevice[] = "constructDebruijnGraphDevice";
...
static char __pyx_k_No_value_specified_for_struct_at[] = "No value specified for struct attribute 'vid'";
...
static char __pyx_k_No_value_specified_for_struct_at_2[] = "No value specified for struct attribute 'ep'";
static char __pyx_k_No_value_specified_for_struct_at_3[] = "No value specified for struct attribute 'ecount'";
static char __pyx_k_No_value_specified_for_struct_at_4[] = "No value specified for struct attribute 'lp'";
static char __pyx_k_No_value_specified_for_struct_at_5[] = "No value specified for struct attribute 'lcount'";
static char __pyx_k_No_value_specified_for_struct_at_6[] = "No value specified for struct attribute 'eid'";
static char __pyx_k_No_value_specified_for_struct_at_7[] = "No value specified for struct attribute 'v1'";
static char __pyx_k_No_value_specified_for_struct_at_8[] = "No value specified for struct attribute 'v2'";
static char __pyx_k_No_value_specified_for_struct_at_9[] = "No value specified for struct attribute 's'";
static char __pyx_k_No_value_specified_for_struct_at_10[] = "No value specified for struct attribute 'pad'";
...
static PyObject *__pyx_n_s_constructDebruijnGraphDevice;
static PyObject *__pyx_kp_s_contiguous_and_direct;
static PyObject *__pyx_kp_s_contiguous_and_indirect;
static PyObject *__pyx_n_s_d_TK;
static PyObject *__pyx_n_s_d_TV;
static PyObject *__pyx_n_s_d_bucketSeed;
static PyObject *__pyx_n_s_d_kmerKeys;
static PyObject *__pyx_n_s_d_lmerKeys;
static PyObject *__pyx_n_s_d_lmerValues;
...
static PyObject *__pyx_n_s_kmerCount;
static PyObject *__pyx_n_s_l;
static PyObject *__pyx_n_s_lcount;
static PyObject *__pyx_n_s_lmerCount;
...
static PyObject *__pyx_n_s_pydebruijn;
...
static PyObject *__pyx_pf_10pydebruijn_constructDebruijnGraphDevice(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_d_lmerKeys, __Pyx_memviewslice __pyx_v_d_lmerValues, PyObject *__pyx_v_lmerCount, __Pyx_memviewslice __pyx_v_d_kmerKeys, PyObject *__pyx_v_kmerCount, PyObject *__pyx_v_l, __Pyx_memviewslice __pyx_v_d_TK, __Pyx_memviewslice __pyx_v_d_TV, __Pyx_memviewslice __pyx_v_d_bucketSeed); /* proto */
...
/* Python wrapper */
static PyObject *__pyx_pw_10pydebruijn_1constructDebruijnGraphDevice(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_10pydebruijn_1constructDebruijnGraphDevice(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_d_lmerKeys = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_d_lmerValues = { 0, 0, { 0 }, { 0 }, { 0 } };
  PyObject *__pyx_v_lmerCount = 0;
  __Pyx_memviewslice __pyx_v_d_kmerKeys = { 0, 0, { 0 }, { 0 }, { 0 } };
  PyObject *__pyx_v_kmerCount = 0;
  PyObject *__pyx_v_l = 0;
  __Pyx_memviewslice __pyx_v_d_TK = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_d_TV = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_d_bucketSeed = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("constructDebruijnGraphDevice (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_d_lmerKeys,&__pyx_n_s_d_lmerValues,&__pyx_n_s_lmerCount,&__pyx_n_s_d_kmerKeys,&__pyx_n_s_kmerCount,&__pyx_n_s_l,&__pyx_n_s_d_TK,&__pyx_n_s_d_TV,&__pyx_n_s_d_bucketSeed,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_d_lmerKeys)) != 0)) kw_args--;
        else goto __pyx_L5_argtuple_error;
        case  1:
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_d_lmerValues)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("constructDebruijnGraphDevice", 1, 9, 9, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 12; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_lmerCount)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("constructDebruijnGraphDevice", 1, 9, 9, 2); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 12; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_d_kmerKeys)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("constructDebruijnGraphDevice", 1, 9, 9, 3); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 12; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  4:
        if (likely((values[4] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_kmerCount)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("constructDebruijnGraphDevice", 1, 9, 9, 4); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 12; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  5:
        if (likely((values[5] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_l)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("constructDebruijnGraphDevice", 1, 9, 9, 5); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 12; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  6:
        if (likely((values[6] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_d_TK)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("constructDebruijnGraphDevice", 1, 9, 9, 6); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 12; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  7:
        if (likely((values[7] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_d_TV)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("constructDebruijnGraphDevice", 1, 9, 9, 7); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 12; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  8:
        if (likely((values[8] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_d_bucketSeed)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("constructDebruijnGraphDevice", 1, 9, 9, 8); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 12; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "constructDebruijnGraphDevice") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 12; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    ...
    __pyx_v_d_lmerKeys = __Pyx_PyObject_to_MemoryviewSlice_ds_int(values[0]); if (unlikely(!__pyx_v_d_lmerKeys.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 12; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_d_lmerValues = __Pyx_PyObject_to_MemoryviewSlice_ds_int(values[1]); if (unlikely(!__pyx_v_d_lmerValues.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 12; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_lmerCount = values[2];
    __pyx_v_d_kmerKeys = __Pyx_PyObject_to_MemoryviewSlice_ds_int(values[3]); if (unlikely(!__pyx_v_d_kmerKeys.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 12; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_kmerCount = values[4];
    __pyx_v_l = values[5];
    __pyx_v_d_TK = __Pyx_PyObject_to_MemoryviewSlice_ds_int(values[6]); if (unlikely(!__pyx_v_d_TK.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 12; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_d_TV = __Pyx_PyObject_to_MemoryviewSlice_ds_int(values[7]); if (unlikely(!__pyx_v_d_TV.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 12; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_d_bucketSeed = __Pyx_PyObject_to_MemoryviewSlice_ds_int(values[8]); if (unlikely(!__pyx_v_d_bucketSeed.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 12; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("constructDebruijnGraphDevice", 1, 9, 9, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 12; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  __Pyx_AddTraceback("pydebruijn.constructDebruijnGraphDevice", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_10pydebruijn_constructDebruijnGraphDevice(__pyx_self, __pyx_v_d_lmerKeys, __pyx_v_d_lmerValues, __pyx_v_lmerCount, __pyx_v_d_kmerKeys, __pyx_v_kmerCount, __pyx_v_l, __pyx_v_d_TK, __pyx_v_d_TV, __pyx_v_d_bucketSeed);
...
static PyObject *__pyx_pf_10pydebruijn_constructDebruijnGraphDevice(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_d_lmerKeys, __Pyx_memviewslice __pyx_v_d_lmerValues, PyObject *__pyx_v_lmerCount, __Pyx_memviewslice __pyx_v_d_kmerKeys, PyObject *__pyx_v_kmerCount, PyObject *__pyx_v_l, __Pyx_memviewslice __pyx_v_d_TK, __Pyx_memviewslice __pyx_v_d_TV, __Pyx_memviewslice __pyx_v_d_bucketSeed) {
  __Pyx_memviewslice __pyx_v_ecount = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_v_bucketCount;
  __Pyx_memviewslice __pyx_v_d_ev = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_d_l = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_d_e = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_d_ee = { 0, 0, { 0 }, { 0 }, { 0 } };
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("constructDebruijnGraphDevice", 0);
 ...
 */
  __pyx_t_1 = __Pyx_PyObject_to_MemoryviewSlice_ds_int(Py_None);
  if (unlikely(!__pyx_t_1.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_v_ecount = __pyx_t_1;
 ...
 *       int[:,:] d_l = None
 */
  __pyx_t_2 = __Pyx_PyObject_to_MemoryviewSlice_dsds_nn_EulerVertex(Py_None);
  if (unlikely(!__pyx_t_2.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 18; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_v_d_ev = __pyx_t_2;
 ...
 *       int[:,:] d_e = None
 */
  __pyx_t_3 = __Pyx_PyObject_to_MemoryviewSlice_dsds_int(Py_None);
  if (unlikely(!__pyx_t_3.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 20; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_v_d_l = __pyx_t_3;
 ...
 */
  __pyx_t_3 = __Pyx_PyObject_to_MemoryviewSlice_dsds_int(Py_None);
  if (unlikely(!__pyx_t_3.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 22; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_v_d_e = __pyx_t_3;
  __pyx_t_3.memview = NULL;
  __pyx_t_3.data = NULL;
 ...
 */
  ...
  __pyx_t_6 = __Pyx_GetModuleGlobalName(__pyx_n_s_pydebruijn); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 26; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_6);
  __pyx_t_7 = __Pyx_PyObject_GetAttrStr(__pyx_t_6, __pyx_n_s_constructDebruijnGraphDevice); if (unlikely(!__pyx_t_7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 26; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 *     d_lmerValues,
 */
  __pyx_t_6 = __pyx_memoryview_fromslice(__pyx_v_ecount, 1, (PyObject *(*)(char *)) __pyx_memview_get_int, (int (*)(char *, PyObject *)) __pyx_memview_set_int, 0);; if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 27; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_6);
 ...
 *     lmerCount,
 */
  __pyx_t_8 = __pyx_memoryview_fromslice(__pyx_v_d_lmerKeys, 1, (PyObject *(*)(char *)) __pyx_memview_get_int, (int (*)(char *, PyObject *)) __pyx_memview_set_int, 0);; if (unlikely(!__pyx_t_8)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 28; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 *     d_kmerKeys,
 */
  __pyx_t_9 = __pyx_memoryview_fromslice(__pyx_v_d_lmerValues, 1, (PyObject *(*)(char *)) __pyx_memview_get_int, (int (*)(char *, PyObject *)) __pyx_memview_set_int, 0);; if (unlikely(!__pyx_t_9)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 29; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 *     l,
 */
  __pyx_t_10 = __pyx_memoryview_fromslice(__pyx_v_d_kmerKeys, 1, (PyObject *(*)(char *)) __pyx_memview_get_int, (int (*)(char *, PyObject *)) __pyx_memview_set_int, 0);; if (unlikely(!__pyx_t_10)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 31; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 *     d_bucketSeed,
 */
  __pyx_t_11 = __pyx_memoryview_fromslice(__pyx_v_d_TK, 1, (PyObject *(*)(char *)) __pyx_memview_get_int, (int (*)(char *, PyObject *)) __pyx_memview_set_int, 0);; if (unlikely(!__pyx_t_11)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 34; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 *     bucketCount,
 */
  __pyx_t_12 = __pyx_memoryview_fromslice(__pyx_v_d_TV, 1, (PyObject *(*)(char *)) __pyx_memview_get_int, (int (*)(char *, PyObject *)) __pyx_memview_set_int, 0);; if (unlikely(!__pyx_t_12)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 35; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 *     d_ev,
 */
  __pyx_t_13 = __pyx_memoryview_fromslice(__pyx_v_d_bucketSeed, 1, (PyObject *(*)(char *)) __pyx_memview_get_int, (int (*)(char *, PyObject *)) __pyx_memview_set_int, 0);; if (unlikely(!__pyx_t_13)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 36; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 *     d_l,
 */
  __pyx_t_14 = __Pyx_PyInt_From_int(__pyx_v_bucketCount); if (unlikely(!__pyx_t_14)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 37; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 *     d_e,
 */
  __pyx_t_15 = __pyx_memoryview_fromslice(__pyx_v_d_ev, 2, (PyObject *(*)(char *)) __pyx_memview_get_nn_EulerVertex, (int (*)(char *, PyObject *)) __pyx_memview_set_nn_EulerVertex, 0);; if (unlikely(!__pyx_t_15)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 38; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 *     d_ee)
 */
  __pyx_t_16 = __pyx_memoryview_fromslice(__pyx_v_d_l, 2, (PyObject *(*)(char *)) __pyx_memview_get_int, (int (*)(char *, PyObject *)) __pyx_memview_set_int, 0);; if (unlikely(!__pyx_t_16)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 39; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 * 
 */
  __pyx_t_17 = __pyx_memoryview_fromslice(__pyx_v_d_e, 2, (PyObject *(*)(char *)) __pyx_memview_get_int, (int (*)(char *, PyObject *)) __pyx_memview_set_int, 0);; if (unlikely(!__pyx_t_17)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 40; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 * 
 */
  __pyx_t_18 = __pyx_memoryview_fromslice(__pyx_v_d_ee, 2, (PyObject *(*)(char *)) __pyx_memview_get_nn_EulerEdge, (int (*)(char *, PyObject *)) __pyx_memview_set_nn_EulerEdge, 0);; if (unlikely(!__pyx_t_18)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 41; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  __pyx_t_21 = PyTuple_New(15+__pyx_t_20); if (unlikely(!__pyx_t_21)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 26; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_21);
  if (__pyx_t_19) {
    __Pyx_GIVEREF(__pyx_t_19); PyTuple_SET_ITEM(__pyx_t_21, 0, __pyx_t_19); __pyx_t_19 = NULL;
  }
  __Pyx_GIVEREF(__pyx_t_6);
  PyTuple_SET_ITEM(__pyx_t_21, 0+__pyx_t_20, __pyx_t_6);
  __Pyx_GIVEREF(__pyx_t_8);
  PyTuple_SET_ITEM(__pyx_t_21, 1+__pyx_t_20, __pyx_t_8);
  __Pyx_GIVEREF(__pyx_t_9);
  PyTuple_SET_ITEM(__pyx_t_21, 2+__pyx_t_20, __pyx_t_9);
  __Pyx_INCREF(__pyx_v_lmerCount);
  __Pyx_GIVEREF(__pyx_v_lmerCount);
  PyTuple_SET_ITEM(__pyx_t_21, 3+__pyx_t_20, __pyx_v_lmerCount);
  __Pyx_GIVEREF(__pyx_t_10);
  PyTuple_SET_ITEM(__pyx_t_21, 4+__pyx_t_20, __pyx_t_10);
  __Pyx_INCREF(__pyx_v_kmerCount);
  __Pyx_GIVEREF(__pyx_v_kmerCount);
  PyTuple_SET_ITEM(__pyx_t_21, 5+__pyx_t_20, __pyx_v_kmerCount);
  __Pyx_INCREF(__pyx_v_l);
  __Pyx_GIVEREF(__pyx_v_l);
  PyTuple_SET_ITEM(__pyx_t_21, 6+__pyx_t_20, __pyx_v_l);
  ...
  __pyx_t_17 = 0;
  __pyx_t_18 = 0;
  __pyx_t_5 = __Pyx_PyObject_Call(__pyx_t_7, __pyx_t_21, NULL); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 26; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 */
  ...
  __pyx_r = NULL;
  __pyx_L0:;
  __PYX_XDEC_MEMVIEW(&__pyx_v_ecount, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_d_ev, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_d_l, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_d_e, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_d_ee, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_d_lmerKeys, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_d_lmerValues, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_d_kmerKeys, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_d_TK, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_d_TV, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_d_bucketSeed, 1);
 ...
 * 
 * @cname("__pyx_convert__from_py_EulerVertex")
 * cdef EulerVertex __pyx_convert__from_py_EulerVertex(obj) except *:             # <<<<<<<<<<<<<<
 *     cdef EulerVertex result
 *     if not PyMapping_Check(obj):
 */

static EulerVertex __pyx_convert__from_py_EulerVertex(PyObject *__pyx_v_obj) {
  EulerVertex __pyx_v_result;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("__pyx_convert__from_py_EulerVertex", 0);
 ...
 *         value = obj['vid']             # <<<<<<<<<<<<<<
 *     except KeyError:
 *         raise ValueError("No value specified for struct attribute 'vid'")
 */
      __pyx_t_2 = PyObject_GetItem(__pyx_v_obj, __pyx_n_s_vid); if (unlikely(__pyx_t_2 == NULL)) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 17; __pyx_clineno = __LINE__; goto __pyx_L4_error;};
      __Pyx_GOTREF(__pyx_t_2);
 ...
 */
    ...
    if (__pyx_t_6) {
      __Pyx_AddTraceback("FromPyStructUtility.__pyx_convert__from_py_EulerVertex", __pyx_clineno, __pyx_lineno, __pyx_filename);
 ...
 *     try:
 */
      __pyx_t_9 = __Pyx_PyObject_Call(__pyx_builtin_ValueError, __pyx_tuple__14, NULL); if (unlikely(!__pyx_t_9)) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 19; __pyx_clineno = __LINE__; goto __pyx_L6_except_error;}
      __Pyx_GOTREF(__pyx_t_9);
      __Pyx_Raise(__pyx_t_9, 0, 0, 0);
      __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
 ...
 *         value = obj['ep']
 */
  __pyx_t_10 = __Pyx_PyInt_As_KEY_T(__pyx_v_value); if (unlikely((__pyx_t_10 == (KEY_T)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 20; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_v_result.vid = __pyx_t_10;
 ...
 *         value = obj['ep']             # <<<<<<<<<<<<<<
 *     except KeyError:
 *         raise ValueError("No value specified for struct attribute 'ep'")
 */
      __pyx_t_8 = PyObject_GetItem(__pyx_v_obj, __pyx_n_s_ep); if (unlikely(__pyx_t_8 == NULL)) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 22; __pyx_clineno = __LINE__; goto __pyx_L14_error;};
      __Pyx_GOTREF(__pyx_t_8);
 ...
 *     try:
 */
      __pyx_t_9 = __Pyx_PyObject_Call(__pyx_builtin_ValueError, __pyx_tuple__15, NULL); if (unlikely(!__pyx_t_9)) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 24; __pyx_clineno = __LINE__; goto __pyx_L16_except_error;}
      __Pyx_GOTREF(__pyx_t_9);
      __Pyx_Raise(__pyx_t_9, 0, 0, 0);
      __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
 ...
 *         value = obj['ecount']
 */
  __pyx_t_6 = __Pyx_PyInt_As_int(__pyx_v_value); if (unlikely((__pyx_t_6 == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 25; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_v_result.ep = __pyx_t_6;
 ...
 *         value = obj['ecount']             # <<<<<<<<<<<<<<
 *     except KeyError:
 *         raise ValueError("No value specified for struct attribute 'ecount'")
 */
      __pyx_t_2 = PyObject_GetItem(__pyx_v_obj, __pyx_n_s_ecount); if (unlikely(__pyx_t_2 == NULL)) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 27; __pyx_clineno = __LINE__; goto __pyx_L24_error;};
      __Pyx_GOTREF(__pyx_t_2);
 ...
 *     try:
 */
      __pyx_t_9 = __Pyx_PyObject_Call(__pyx_builtin_ValueError, __pyx_tuple__16, NULL); if (unlikely(!__pyx_t_9)) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 29; __pyx_clineno = __LINE__; goto __pyx_L26_except_error;}
      __Pyx_GOTREF(__pyx_t_9);
      __Pyx_Raise(__pyx_t_9, 0, 0, 0);
      __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
 ...
 *         value = obj['lp']
 */
  __pyx_t_6 = __Pyx_PyInt_As_int(__pyx_v_value); if (unlikely((__pyx_t_6 == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 30; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_v_result.ecount = __pyx_t_6;
 ...
 *         value = obj['lp']             # <<<<<<<<<<<<<<
 *     except KeyError:
 *         raise ValueError("No value specified for struct attribute 'lp'")
 */
      __pyx_t_8 = PyObject_GetItem(__pyx_v_obj, __pyx_n_s_lp); if (unlikely(__pyx_t_8 == NULL)) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 32; __pyx_clineno = __LINE__; goto __pyx_L34_error;};
      __Pyx_GOTREF(__pyx_t_8);
      __Pyx_DECREF_SET(__pyx_v_value, __pyx_t_8);
      __pyx_t_8 = 0;
 ...
 *     try:
 */
      __pyx_t_9 = __Pyx_PyObject_Call(__pyx_builtin_ValueError, __pyx_tuple__17, NULL); if (unlikely(!__pyx_t_9)) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 34; __pyx_clineno = __LINE__; goto __pyx_L36_except_error;}
      __Pyx_GOTREF(__pyx_t_9);
      __Pyx_Raise(__pyx_t_9, 0, 0, 0);
      __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
 ...
 *         value = obj['lcount']
 */
  __pyx_t_6 = __Pyx_PyInt_As_int(__pyx_v_value); if (unlikely((__pyx_t_6 == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 35; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_v_result.lp = __pyx_t_6;
 ...
 *         value = obj['lcount']             # <<<<<<<<<<<<<<
 *     except KeyError:
 *         raise ValueError("No value specified for struct attribute 'lcount'")
 */
      __pyx_t_2 = PyObject_GetItem(__pyx_v_obj, __pyx_n_s_lcount); if (unlikely(__pyx_t_2 == NULL)) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 37; __pyx_clineno = __LINE__; goto __pyx_L44_error;};
      __Pyx_GOTREF(__pyx_t_2);
      __Pyx_DECREF_SET(__pyx_v_value, __pyx_t_2);
      __pyx_t_2 = 0;
 ...
 *     return result
 */
      __pyx_t_9 = __Pyx_PyObject_Call(__pyx_builtin_ValueError, __pyx_tuple__18, NULL); if (unlikely(!__pyx_t_9)) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 39; __pyx_clineno = __LINE__; goto __pyx_L46_except_error;}
      __Pyx_GOTREF(__pyx_t_9);
      __Pyx_Raise(__pyx_t_9, 0, 0, 0);
      __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
 ...
 * 
 */
  __pyx_t_6 = __Pyx_PyInt_As_int(__pyx_v_value); if (unlikely((__pyx_t_6 == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 40; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_v_result.lcount = __pyx_t_6;
...
static EulerEdge __pyx_convert__from_py_EulerEdge(PyObject *__pyx_v_obj) {
  EulerEdge __pyx_v_result;
  PyObject *__pyx_v_value = NULL;
  EulerEdge __pyx_r;
  __Pyx_RefNannyDeclarations
  int __pyx_t_1;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("__pyx_convert__from_py_EulerEdge", 0);

  /* "FromPyStructUtility":13
 * cdef EulerEdge __pyx_convert__from_py_EulerEdge(obj) except *:
 *     cdef EulerEdge result
 *     if not PyMapping_Check(obj):             # <<<<<<<<<<<<<<
 *         PyErr_Format(TypeError, b"Expected %.16s, got %.200s", b"a mapping", Py_TYPE(obj).tp_name)
 * 
 */
 ...
 *         value = obj['eid']             # <<<<<<<<<<<<<<
 *     except KeyError:
 *         raise ValueError("No value specified for struct attribute 'eid'")
 */
      __pyx_t_2 = PyObject_GetItem(__pyx_v_obj, __pyx_n_s_eid); if (unlikely(__pyx_t_2 == NULL)) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 17; __pyx_clineno = __LINE__; goto __pyx_L4_error;};
      __Pyx_GOTREF(__pyx_t_2);
      __pyx_v_value = __pyx_t_2;
      __pyx_t_2 = 0;
 ...
 */
    __pyx_t_6 = PyErr_ExceptionMatches(__pyx_builtin_KeyError);
    if (__pyx_t_6) {
      __Pyx_AddTraceback("FromPyStructUtility.__pyx_convert__from_py_EulerEdge", __pyx_clineno, __pyx_lineno, __pyx_filename);
      if (__Pyx_GetException(&__pyx_t_2, &__pyx_t_7, &__pyx_t_8) < 0) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 18; __pyx_clineno = __LINE__; goto __pyx_L6_except_error;}
      __Pyx_GOTREF(__pyx_t_2);
      __Pyx_GOTREF(__pyx_t_7);
      __Pyx_GOTREF(__pyx_t_8);
 ...
 *     try:
 */
      __pyx_t_9 = __Pyx_PyObject_Call(__pyx_builtin_ValueError, __pyx_tuple__19, NULL); if (unlikely(!__pyx_t_9)) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 19; __pyx_clineno = __LINE__; goto __pyx_L6_except_error;}
      __Pyx_GOTREF(__pyx_t_9);
      __Pyx_Raise(__pyx_t_9, 0, 0, 0);
      __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
      {__pyx_filename = __pyx_f[1]; __pyx_lineno = 19; __pyx_clineno = __LINE__; goto __pyx_L6_except_error;}
 ...
 *         value = obj['v1']             # <<<<<<<<<<<<<<
 *     except KeyError:
 *         raise ValueError("No value specified for struct attribute 'v1'")
 */
      __pyx_t_8 = PyObject_GetItem(__pyx_v_obj, __pyx_n_s_v1); if (unlikely(__pyx_t_8 == NULL)) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 22; __pyx_clineno = __LINE__; goto __pyx_L14_error;};
      __Pyx_GOTREF(__pyx_t_8);
      __Pyx_DECREF_SET(__pyx_v_value, __pyx_t_8);
      __pyx_t_8 = 0;
 ...
 *     try:
 */
      __pyx_t_9 = __Pyx_PyObject_Call(__pyx_builtin_ValueError, __pyx_tuple__20, NULL); if (unlikely(!__pyx_t_9)) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 24; __pyx_clineno = __LINE__; goto __pyx_L16_except_error;}
      __Pyx_GOTREF(__pyx_t_9);
      __Pyx_Raise(__pyx_t_9, 0, 0, 0);
      __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
      {__pyx_filename = __pyx_f[1]; __pyx_lineno = 24; __pyx_clineno = __LINE__; goto __pyx_L16_except_error;}
 ...
 *         value = obj['v2']             # <<<<<<<<<<<<<<
 *     except KeyError:
 *         raise ValueError("No value specified for struct attribute 'v2'")
 */
      __pyx_t_2 = PyObject_GetItem(__pyx_v_obj, __pyx_n_s_v2); if (unlikely(__pyx_t_2 == NULL)) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 27; __pyx_clineno = __LINE__; goto __pyx_L24_error;};
      __Pyx_GOTREF(__pyx_t_2);
      __Pyx_DECREF_SET(__pyx_v_value, __pyx_t_2);
      __pyx_t_2 = 0;
 ...
 *     try:
 */
      __pyx_t_9 = __Pyx_PyObject_Call(__pyx_builtin_ValueError, __pyx_tuple__21, NULL); if (unlikely(!__pyx_t_9)) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 29; __pyx_clineno = __LINE__; goto __pyx_L26_except_error;}
      __Pyx_GOTREF(__pyx_t_9);
      __Pyx_Raise(__pyx_t_9, 0, 0, 0);
      __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
      {__pyx_filename = __pyx_f[1]; __pyx_lineno = 29; __pyx_clineno = __LINE__; goto __pyx_L26_except_error;}
 ...
 */
      __pyx_t_8 = PyObject_GetItem(__pyx_v_obj, __pyx_n_s_s); if (unlikely(__pyx_t_8 == NULL)) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 32; __pyx_clineno = __LINE__; goto __pyx_L34_error;};
      __Pyx_GOTREF(__pyx_t_8);
      __Pyx_DECREF_SET(__pyx_v_value, __pyx_t_8);
      __pyx_t_8 = 0;
 ...
 *     try:
 */
      __pyx_t_9 = __Pyx_PyObject_Call(__pyx_builtin_ValueError, __pyx_tuple__22, NULL); if (unlikely(!__pyx_t_9)) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 34; __pyx_clineno = __LINE__; goto __pyx_L36_except_error;}
      __Pyx_GOTREF(__pyx_t_9);
      __Pyx_Raise(__pyx_t_9, 0, 0, 0);
      __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
      {__pyx_filename = __pyx_f[1]; __pyx_lineno = 34; __pyx_clineno = __LINE__; goto __pyx_L36_except_error;}
 ...
 *         value = obj['pad']             # <<<<<<<<<<<<<<
 *     except KeyError:
 *         raise ValueError("No value specified for struct attribute 'pad'")
 */
      __pyx_t_2 = PyObject_GetItem(__pyx_v_obj, __pyx_n_s_pad); if (unlikely(__pyx_t_2 == NULL)) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 37; __pyx_clineno = __LINE__; goto __pyx_L44_error;};
      __Pyx_GOTREF(__pyx_t_2);
      __Pyx_DECREF_SET(__pyx_v_value, __pyx_t_2);
      __pyx_t_2 = 0;
 ...
 *     return result
 */
      __pyx_t_9 = __Pyx_PyObject_Call(__pyx_builtin_ValueError, __pyx_tuple__23, NULL); if (unlikely(!__pyx_t_9)) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 39; __pyx_clineno = __LINE__; goto __pyx_L46_except_error;}
      __Pyx_GOTREF(__pyx_t_9);
      __Pyx_Raise(__pyx_t_9, 0, 0, 0);
      __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
      {__pyx_filename = __pyx_f[1]; __pyx_lineno = 39; __pyx_clineno = __LINE__; goto __pyx_L46_except_error;}
 ...
 */
  ...
  /* "FromPyStructUtility":11
 * 
 * @cname("__pyx_convert__from_py_EulerEdge")
 * cdef EulerEdge __pyx_convert__from_py_EulerEdge(obj) except *:             # <<<<<<<<<<<<<<
 *     cdef EulerEdge result
 *     if not PyMapping_Check(obj):
 */
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "pydebruijn._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"constructDebruijnGraphDevice", (PyCFunction)__pyx_pw_10pydebruijn_1constructDebruijnGraphDevice, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_constructDebruijnGraphDevice, __pyx_k_constructDebruijnGraphDevice, sizeof(__pyx_k_constructDebruijnGraphDevice), 0, 0, 1, 1},
  {&__pyx_kp_s_contiguous_and_direct, __pyx_k_contiguous_and_direct, sizeof(__pyx_k_contiguous_and_direct), 0, 0, 1, 0},
  {&__pyx_kp_s_contiguous_and_indirect, __pyx_k_contiguous_and_indirect, sizeof(__pyx_k_contiguous_and_indirect), 0, 0, 1, 0},
  {&__pyx_n_s_d_TK, __pyx_k_d_TK, sizeof(__pyx_k_d_TK), 0, 0, 1, 1},
  {&__pyx_n_s_d_TV, __pyx_k_d_TV, sizeof(__pyx_k_d_TV), 0, 0, 1, 1},
  {&__pyx_n_s_d_bucketSeed, __pyx_k_d_bucketSeed, sizeof(__pyx_k_d_bucketSeed), 0, 0, 1, 1},
  {&__pyx_n_s_d_kmerKeys, __pyx_k_d_kmerKeys, sizeof(__pyx_k_d_kmerKeys), 0, 0, 1, 1},
  {&__pyx_n_s_d_lmerKeys, __pyx_k_d_lmerKeys, sizeof(__pyx_k_d_lmerKeys), 0, 0, 1, 1},
  {&__pyx_n_s_d_lmerValues, __pyx_k_d_lmerValues, sizeof(__pyx_k_d_lmerValues), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_kmerCount, __pyx_k_kmerCount, sizeof(__pyx_k_kmerCount), 0, 0, 1, 1},
  {&__pyx_n_s_l, __pyx_k_l, sizeof(__pyx_k_l), 0, 0, 1, 1},
  {&__pyx_n_s_lcount, __pyx_k_lcount, sizeof(__pyx_k_lcount), 0, 0, 1, 1},
  {&__pyx_n_s_lmerCount, __pyx_k_lmerCount, sizeof(__pyx_k_lmerCount), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_pydebruijn, __pyx_k_pydebruijn, sizeof(__pyx_k_pydebruijn), 0, 0, 1, 1},
 ...
 *     try:
 */
  __pyx_tuple__14 = PyTuple_Pack(1, __pyx_kp_s_No_value_specified_for_struct_at); if (unlikely(!__pyx_tuple__14)) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 19; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 *     try:
 */
  __pyx_tuple__15 = PyTuple_Pack(1, __pyx_kp_s_No_value_specified_for_struct_at_2); if (unlikely(!__pyx_tuple__15)) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 24; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 *     try:
 */
  __pyx_tuple__16 = PyTuple_Pack(1, __pyx_kp_s_No_value_specified_for_struct_at_3); if (unlikely(!__pyx_tuple__16)) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 29; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 *     try:
 */
  __pyx_tuple__17 = PyTuple_Pack(1, __pyx_kp_s_No_value_specified_for_struct_at_4); if (unlikely(!__pyx_tuple__17)) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 34; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 *     return result
 */
  __pyx_tuple__18 = PyTuple_Pack(1, __pyx_kp_s_No_value_specified_for_struct_at_5); if (unlikely(!__pyx_tuple__18)) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 39; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 *     try:
 */
  __pyx_tuple__19 = PyTuple_Pack(1, __pyx_kp_s_No_value_specified_for_struct_at_6); if (unlikely(!__pyx_tuple__19)) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 19; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 *     try:
 */
  __pyx_tuple__20 = PyTuple_Pack(1, __pyx_kp_s_No_value_specified_for_struct_at_7); if (unlikely(!__pyx_tuple__20)) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 24; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 *     try:
 */
  __pyx_tuple__21 = PyTuple_Pack(1, __pyx_kp_s_No_value_specified_for_struct_at_8); if (unlikely(!__pyx_tuple__21)) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 29; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 *     try:
 */
  __pyx_tuple__22 = PyTuple_Pack(1, __pyx_kp_s_No_value_specified_for_struct_at_9); if (unlikely(!__pyx_tuple__22)) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 34; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 *     return result
 */
  __pyx_tuple__23 = PyTuple_Pack(1, __pyx_kp_s_No_value_specified_for_struct_at_10); if (unlikely(!__pyx_tuple__23)) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 39; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initpydebruijn(void); /*proto*/
PyMODINIT_FUNC initpydebruijn(void)
#else
PyMODINIT_FUNC PyInit_pydebruijn(void); /*proto*/
PyMODINIT_FUNC PyInit_pydebruijn(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_pydebruijn(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("pydebruijn", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_pydebruijn) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    if (!PyDict_GetItemString(modules, "pydebruijn")) {
      if (unlikely(PyDict_SetItemString(modules, "pydebruijn", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 * cdef indirect = Enum("<strided and indirect>")
 */
  __pyx_t_1 = __Pyx_PyObject_Call(((PyObject *)__pyx_MemviewEnum_type), __pyx_tuple__24, NULL); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 278; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
 ...
 * 
 */
  __pyx_t_1 = __Pyx_PyObject_Call(((PyObject *)__pyx_MemviewEnum_type), __pyx_tuple__25, NULL); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 279; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
 ...
 * 
 */
  __pyx_t_1 = __Pyx_PyObject_Call(((PyObject *)__pyx_MemviewEnum_type), __pyx_tuple__26, NULL); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 280; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
 ...
 * 
 */
  __pyx_t_1 = __Pyx_PyObject_Call(((PyObject *)__pyx_MemviewEnum_type), __pyx_tuple__27, NULL); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 283; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
 ...
 * 
 */
  __pyx_t_1 = __Pyx_PyObject_Call(((PyObject *)__pyx_MemviewEnum_type), __pyx_tuple__28, NULL); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 284; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init pydebruijn", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init pydebruijn");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
...
static CYTHON_INLINE PyObject* __Pyx_PyInt_From_KEY_T(KEY_T value) {
    const KEY_T neg_one = (KEY_T) -1, const_zero = (KEY_T) 0;
    const int is_unsigned = neg_one > const_zero;
    if (is_unsigned) {
        if (sizeof(KEY_T) < sizeof(long)) {
            return PyInt_FromLong((long) value);
        } else if (sizeof(KEY_T) <= sizeof(unsigned long)) {
            return PyLong_FromUnsignedLong((unsigned long) value);
        } else if (sizeof(KEY_T) <= sizeof(unsigned PY_LONG_LONG)) {
            return PyLong_FromUnsignedLongLong((unsigned PY_LONG_LONG) value);
        }
    } else {
        if (sizeof(KEY_T) <= sizeof(long)) {
            return PyInt_FromLong((long) value);
        } else if (sizeof(KEY_T) <= sizeof(PY_LONG_LONG)) {
            return PyLong_FromLongLong((PY_LONG_LONG) value);
        }
    }
    {
        int one = 1; int little = (int)*(unsigned char *)&one;
        unsigned char *bytes = (unsigned char *)&value;
        return _PyLong_FromByteArray(bytes, sizeof(KEY_T),
                                     little, !is_unsigned);
    }
}
...
static PyObject* __pyx_convert__to_py_EulerVertex(EulerVertex s) {
          ...
          member = __Pyx_PyInt_From_KEY_T(s.vid); if (member == NULL) goto bad;
          if (PyDict_SetItem(res, __pyx_n_s_vid, member) < 0) goto bad;
          Py_DECREF(member);
          member = __Pyx_PyInt_From_int(s.ep); if (member == NULL) goto bad;
          if (PyDict_SetItem(res, __pyx_n_s_ep, member) < 0) goto bad;
          Py_DECREF(member);
          member = __Pyx_PyInt_From_int(s.ecount); if (member == NULL) goto bad;
          if (PyDict_SetItem(res, __pyx_n_s_ecount, member) < 0) goto bad;
          Py_DECREF(member);
          member = __Pyx_PyInt_From_int(s.lp); if (member == NULL) goto bad;
          if (PyDict_SetItem(res, __pyx_n_s_lp, member) < 0) goto bad;
          Py_DECREF(member);
          member = __Pyx_PyInt_From_int(s.lcount); if (member == NULL) goto bad;
          if (PyDict_SetItem(res, __pyx_n_s_lcount, member) < 0) goto bad;
          Py_DECREF(member);
          return res;
          bad:
          Py_XDECREF(member);
        ...
        static CYTHON_INLINE KEY_T __Pyx_PyInt_As_KEY_T(PyObject *x) {
    const KEY_T neg_one = (KEY_T) -1, const_zero = (KEY_T) 0;
    const int is_unsigned = neg_one > const_zero;
#if PY_MAJOR_VERSION < 3
    if (likely(PyInt_Check(x))) {
        if (sizeof(KEY_T) < sizeof(long)) {
            __PYX_VERIFY_RETURN_INT(KEY_T, long, PyInt_AS_LONG(x))
        } else {
            long val = PyInt_AS_LONG(x);
            if (is_unsigned && unlikely(val < 0)) {
                goto raise_neg_overflow;
    ...
    if (likely(PyLong_Check(x))) {
        if (is_unsigned) {
            ...
            const digit* digits = ((PyLongObject*)x)->ob_digit;
            switch (Py_SIZE(x)) {
                case  0: return (KEY_T) 0;
                case  1: __PYX_VERIFY_RETURN_INT(KEY_T, digit, digits[0])
                case 2:
                    if (8 * sizeof(KEY_T) > 1 * PyLong_SHIFT) {
                        if (8 * sizeof(unsigned long) > 2 * PyLong_SHIFT) {
                            __PYX_VERIFY_RETURN_INT(KEY_T, unsigned long, (((((unsigned long)digits[1]) << PyLong_SHIFT) | (unsigned long)digits[0])))
                        } else if (8 * sizeof(KEY_T) >= 2 * PyLong_SHIFT) {
                            return (KEY_T) (((((KEY_T)digits[1]) << PyLong_SHIFT) | (KEY_T)digits[0]));
                        }
                    }
                    break;
                case 3:
                    if (8 * sizeof(KEY_T) > 2 * PyLong_SHIFT) {
                        if (8 * sizeof(unsigned long) > 3 * PyLong_SHIFT) {
                            __PYX_VERIFY_RETURN_INT(KEY_T, unsigned long, (((((((unsigned long)digits[2]) << PyLong_SHIFT) | (unsigned long)digits[1]) << PyLong_SHIFT) | (unsigned long)digits[0])))
                        } else if (8 * sizeof(KEY_T) >= 3 * PyLong_SHIFT) {
                            return (KEY_T) (((((((KEY_T)digits[2]) << PyLong_SHIFT) | (KEY_T)digits[1]) << PyLong_SHIFT) | (KEY_T)digits[0]));
                        }
                    }
                    break;
                case 4:
                    if (8 * sizeof(KEY_T) > 3 * PyLong_SHIFT) {
                        if (8 * sizeof(unsigned long) > 4 * PyLong_SHIFT) {
                            __PYX_VERIFY_RETURN_INT(KEY_T, unsigned long, (((((((((unsigned long)digits[3]) << PyLong_SHIFT) | (unsigned long)digits[2]) << PyLong_SHIFT) | (unsigned long)digits[1]) << PyLong_SHIFT) | (unsigned long)digits[0])))
                        } else if (8 * sizeof(KEY_T) >= 4 * PyLong_SHIFT) {
                            return (KEY_T) (((((((((KEY_T)digits[3]) << PyLong_SHIFT) | (KEY_T)digits[2]) << PyLong_SHIFT) | (KEY_T)digits[1]) << PyLong_SHIFT) | (KEY_T)digits[0]));
                        }
                    }
                    break;
            }
...
#endif
            if (sizeof(KEY_T) <= sizeof(unsigned long)) {
                __PYX_VERIFY_RETURN_INT_EXC(KEY_T, unsigned long, PyLong_AsUnsignedLong(x))
            } else if (sizeof(KEY_T) <= sizeof(unsigned PY_LONG_LONG)) {
                __PYX_VERIFY_RETURN_INT_EXC(KEY_T, unsigned PY_LONG_LONG, PyLong_AsUnsignedLongLong(x))
            }
        } else {
#if CYTHON_USE_PYLONG_INTERNALS
            const digit* digits = ((PyLongObject*)x)->ob_digit;
            switch (Py_SIZE(x)) {
                case  0: return (KEY_T) 0;
                case -1: __PYX_VERIFY_RETURN_INT(KEY_T, sdigit, -(sdigit) digits[0])
                case  1: __PYX_VERIFY_RETURN_INT(KEY_T,  digit, +digits[0])
                case -2:
                    if (8 * sizeof(KEY_T) - 1 > 1 * PyLong_SHIFT) {
                        if (8 * sizeof(unsigned long) > 2 * PyLong_SHIFT) {
                            __PYX_VERIFY_RETURN_INT(KEY_T, long, -(long) (((((unsigned long)digits[1]) << PyLong_SHIFT) | (unsigned long)digits[0])))
                        } else if (8 * sizeof(KEY_T) - 1 > 2 * PyLong_SHIFT) {
                            return (KEY_T) (((KEY_T)-1)*(((((KEY_T)digits[1]) << PyLong_SHIFT) | (KEY_T)digits[0])));
                        }
                    }
                    break;
                case 2:
                    ...
                    break;
                case -3:
                    if (8 * sizeof(KEY_T) - 1 > 2 * PyLong_SHIFT) {
                        if (8 * sizeof(unsigned long) > 3 * PyLong_SHIFT) {
                            __PYX_VERIFY_RETURN_INT(KEY_T, long, -(long) (((((((unsigned long)digits[2]) << PyLong_SHIFT) | (unsigned long)digits[1]) << PyLong_SHIFT) | (unsigned long)digits[0])))
                        } else if (8 * sizeof(KEY_T) - 1 > 3 * PyLong_SHIFT) {
                            return (KEY_T) (((KEY_T)-1)*(((((((KEY_T)digits[2]) << PyLong_SHIFT) | (KEY_T)digits[1]) << PyLong_SHIFT) | (KEY_T)digits[0])));
                        }
                    }
                    break;
                case 3:
                    ...
                    break;
                case -4:
                    if (8 * sizeof(KEY_T) - 1 > 3 * PyLong_SHIFT) {
                        if (8 * sizeof(unsigned long) > 4 * PyLong_SHIFT) {
                            __PYX_VERIFY_RETURN_INT(KEY_T, long, -(long) (((((((((unsigned long)digits[3]) << PyLong_SHIFT) | (unsigned long)digits[2]) << PyLong_SHIFT) | (unsigned long)digits[1]) << PyLong_SHIFT) | (unsigned long)digits[0])))
                        } else if (8 * sizeof(KEY_T) - 1 > 4 * PyLong_SHIFT) {
                            return (KEY_T) (((KEY_T)-1)*(((((((((KEY_T)digits[3]) << PyLong_SHIFT) | (KEY_T)digits[2]) << PyLong_SHIFT) | (KEY_T)digits[1]) << PyLong_SHIFT) | (KEY_T)digits[0])));
                        }
                    }
                    break;
                case 4:
...
#endif
            if (sizeof(KEY_T) <= sizeof(long)) {
                __PYX_VERIFY_RETURN_INT_EXC(KEY_T, long, PyLong_AsLong(x))
            } else if (sizeof(KEY_T) <= sizeof(PY_LONG_LONG)) {
                __PYX_VERIFY_RETURN_INT_EXC(KEY_T, PY_LONG_LONG, PyLong_AsLongLong(x))
            }
        }
        {
#if CYTHON_COMPILING_IN_PYPY && !defined(_PyLong_AsByteArray)
        ...
        KEY_T val;
        PyObject *tmp = __Pyx_PyNumber_Int(x);
        if (!tmp) return (KEY_T) -1;
        val = __Pyx_PyInt_As_KEY_T(tmp);
        Py_DECREF(tmp);
        return val;
    }
raise_overflow:
    PyErr_SetString(PyExc_OverflowError,
        "value too large to convert to KEY_T");
    return (KEY_T) -1;
raise_neg_overflow:
    PyErr_SetString(PyExc_OverflowError,
        "can't convert negative value to KEY_T");
    return (KEY_T) -1;
}

static PyObject *__pyx_memview_get_nn_EulerVertex(const char *itemp) {
    return (PyObject *) __pyx_convert__to_py_EulerVertex(*(EulerVertex *) itemp);
}
static int __pyx_memview_set_nn_EulerVertex(const char *itemp, PyObject *obj) {
    EulerVertex value = __pyx_convert__from_py_EulerVertex(obj);
    if (PyErr_Occurred())
        return 0;
    *(EulerVertex *) itemp = value;
    return 1;
}
...
static PyObject* __pyx_convert__to_py_EulerEdge(EulerEdge s) {
          ...
          PyObject* member;
          res = PyDict_New(); if (res == NULL) return NULL;
          member = __Pyx_PyInt_From_KEY_T(s.eid); if (member == NULL) goto bad;
          if (PyDict_SetItem(res, __pyx_n_s_eid, member) < 0) goto bad;
          Py_DECREF(member);
          member = __Pyx_PyInt_From_int(s.v1); if (member == NULL) goto bad;
          if (PyDict_SetItem(res, __pyx_n_s_v1, member) < 0) goto bad;
          Py_DECREF(member);
          member = __Pyx_PyInt_From_int(s.v2); if (member == NULL) goto bad;
          if (PyDict_SetItem(res, __pyx_n_s_v2, member) < 0) goto bad;
          Py_DECREF(member);
          member = __Pyx_PyInt_From_int(s.s); if (member == NULL) goto bad;
          if (PyDict_SetItem(res, __pyx_n_s_s, member) < 0) goto bad;
          Py_DECREF(member);
          member = __Pyx_PyInt_From_int(s.pad); if (member == NULL) goto bad;
          if (PyDict_SetItem(res, __pyx_n_s_pad, member) < 0) goto bad;
          Py_DECREF(member);
          return res;
          bad:
          Py_XDECREF(member);
        ...
        static PyObject *__pyx_memview_get_nn_EulerEdge(const char *itemp) {
    return (PyObject *) __pyx_convert__to_py_EulerEdge(*(EulerEdge *) itemp);
}
static int __pyx_memview_set_nn_EulerEdge(const char *itemp, PyObject *obj) {
    EulerEdge value = __pyx_convert__from_py_EulerEdge(obj);
    if (PyErr_Occurred())
        return 0;
    *(EulerEdge *) itemp = value;
    return 1;
}
...
static CYTHON_INLINE __Pyx_memviewslice __Pyx_PyObject_to_MemoryviewSlice_dsds_nn_EulerVertex(PyObject *obj) {
    __Pyx_memviewslice result = { 0, 0, { 0 }, { 0 }, { 0 } };
    ...
    retcode = __Pyx_ValidateAndInit_memviewslice(axes_specs, 0,
                                                 PyBUF_RECORDS, 2,
                                                 &__Pyx_TypeInfo_nn_EulerVertex, stack,
                                                 &result, obj);
    if (unlikely(retcode == -1))
        goto __pyx_fail;
    return result;
...
static CYTHON_INLINE __Pyx_memviewslice __Pyx_PyObject_to_MemoryviewSlice_dsds_nn_EulerEdge(PyObject *obj) {
    __Pyx_memviewslice result = { 0, 0, { 0 }, { 0 }, { 0 } };
    __Pyx_BufFmt_StackElem stack[2];
    int axes_specs[] = { (__Pyx_MEMVIEW_DIRECT | __Pyx_MEMVIEW_STRIDED), (__Pyx_MEMVIEW_DIRECT | __Pyx_MEMVIEW_STRIDED) };
    int retcode;
    ...
    retcode = __Pyx_ValidateAndInit_memviewslice(axes_specs, 0,
                                                 PyBUF_RECORDS, 2,
                                                 &__Pyx_TypeInfo_nn_EulerEdge, stack,
                                                 &result, obj);
    if (unlikely(retcode == -1))
        goto __pyx_fail;
    return result;
